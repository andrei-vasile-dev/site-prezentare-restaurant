...
<body><br><br>';
    ...
    echo ' <a href="vezi-rezervari.php" class="myButton">INAPOI LA SITE</a>';
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (empty($numar_persoane) || empty($data) || empty($ora) || empty($loc) || empty($telefon)) {
            ...
            if (mysqli_query($conn, $sql_insert)) {
                ...
                echo '<p>Masa este păstrată pentru 15 minute după ora rezervării.</p>';
                echo'<p>Apreciem dacă ajungeți la timp.</p>';
                echo '<a href="vezi-rezervari.php"><button>Înapoi la Site</button></a></div>';
                exit;
            } else {
